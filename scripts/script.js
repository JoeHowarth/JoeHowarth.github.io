...
function pushPoi(location, prefDist, priceWeight, tripLocs, points){
    ...
    $.ajax({
        url: "https://api.tripadvisor.com/api/partner/2.0/map/"+ location + "/attractions?key=AIzaSyDyifMNPY2-AG4ry0JCQgG3DwVmuRILpu4", 
        dataType: "json",
...
function weightPoi(poiAry, prefDist, priceWeight){
    ...
    for(var i = 0; i < poiAry.length; i++){
        ...
        var randBonus = (Math.random() * 2 - 1) * randArea;
